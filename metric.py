...
def visualize_and_save_samples(ori_data, save_dir):
    # 检查目录是否存在，如果不存在，则创建
...
def visualization(ori_data, generated_data1, analysis):
    ...
    if analysis == "tsne":
        ...
        plt.savefig("result" +"/"+ "tsne.png", dpi=100, bbox_inches='tight')
        plt.close()
    elif analysis == "pca":
        ...
        plt.savefig("result" +"/"+ "_PCA.png", dpi=100, bbox_inches='tight')
        plt.close()
...
generated_data1= np.random.rand(1000, 24, 15)
generated_data2= np.random.rand(1000, 24, 15)


print("visulization normal serises saving")
visualize_and_save_samples(generated_data1, '{}_noraml_ori_samples{}'.format(data, seq_len))
visualize_and_save_samples(generated_data2, '{}_noraml_sys_samples{}'.format(data, seq_len))
print("visulization normal PCA tsne saving")
visualization(generated_data1, generated_data2, "tsne")
visualization(generated_data1, generated_data2, "pca")
